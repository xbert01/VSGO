    ...
    <>
      <div className='game'>
        ...
        <div class="term-actions">
          <button class="game-button term-actions__button term-actions__button--higher">Higher</button><button class="game-button term-actions__button term-actions__button--lower">Lower</button><div><!-- react-text: 199 -->searches than <!-- /react-text --><!-- react-text: 200 -->Democracy<!-- /react-text --></div></div>
        {/* <Buttons /> */}
      </div>
    </>
  );
